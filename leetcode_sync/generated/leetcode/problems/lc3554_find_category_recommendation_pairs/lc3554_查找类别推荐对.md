...
<tr><td><b>链接</b></td><td><a href="https://leetcode.cn/problems/find-category-recommendation-pairs/description/">在线练习</a></td></tr>
</table>
...
返回可报告类别对的结果表以 _ _**customer_count** _ _**降序** __ 排序，并且为了防止排序持平，以 _ _**category1** 字典序**升序**  排序，然后以 **category2 升序**  排序。
结果格式如下所示。
