...
<tr><td><b>链接</b></td><td><a href="https://leetcode.cn/problems/minimum-edge-reversals-so-every-node-is-reachable/description/">在线练习</a></td></tr>
</table>
...
请你返回一个长度为 `n` 的整数数组 _ _`answer` _ _ ，其中 _ _`answer[i]`表示从节点 `i` 出发，可以到达所有节点的 **最少边反转**  次数。
