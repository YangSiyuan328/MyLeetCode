...
<tr><td><b>链接</b></td><td><a href="https://leetcode.cn/problems/find-covid-recovery-patients/description/">在线练习</a></td></tr>
</table>
...
返回结果表以 _ _`recovery_time` __**升序** 排序，然后以 _ _`patient_name` __**升序  **排序。
结果格式如下所示。
