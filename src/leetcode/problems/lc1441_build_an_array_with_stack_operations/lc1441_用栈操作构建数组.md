...
<tr><td><b>链接</b></td><td><a href="https://leetcode.cn/problems/build-an-array-with-stack-operations/description/">在线练习</a></td></tr>
</table>
...
**解释：** 一开始栈为空。最后一个元素是栈顶。**** 从流中读取 1 并推入数组。s = [1]。
从流中读取 2 并推入数组。s = [1,2]。
从栈顶删除整数。s = [1]。
从流中读取 3 并推入数组。s = [1,3]。
