...
<tr><td><b>标签</b></td><td>双指针;字符串;枚举</td></tr>
<tr><td><b>会员</b></td><td>否</td></tr>
<tr><td><b>链接</b></td><td><a href="https://leetcode.cn/problems/lexicographically-smallest-palindromic-permutation-greater-than-target/description/">在线练习</a></td></tr>
</table>
...
返回 **字典序最小的字符串  **，该字符串 **既  **是 `s` 的一个 **回文排列  **，**又** 是字典序 **严格  **大于 `target` 的。如果不存在这样的排列，则返回一个空字符串。
