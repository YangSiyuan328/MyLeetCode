...
<tr><td><b>链接</b></td><td><a href="https://leetcode.cn/problems/process-restricted-friend-requests/description/">在线练习</a></td></tr>
</table>
...
返回一个 **布尔数组** `result` ，其中元素遵循此规则：如果第 `j` 个好友请求 **成功** __ ，那么 `result[j]`__ 就是 __`true` __ ；否则，为 __`false` 。
